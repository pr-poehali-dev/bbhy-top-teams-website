...
export const teams: Team[] = [
  ...
  },
  {
    ...
    change: 1,
    players: [
      { name: "m0nstor", role: "Снайпер", rating: 1.31 },
      { name: "Raven", role: "Рифлер", rating: 1.21 },
      { name: "Alalakai", role: "Рифлер", rating: 1.17 },
      { name: "Koku", role: "Капитан", rating: 1.12 },
      { name: "DqZzxt", role: "Поддержка", rating: 1.05 },
    ],
  },
  {
    rank: 3,
